...
const { getFavorites, saveFavorites, addFavorite, removeFavorite, getHistory, saveHistory, addHistory, removeHistory } = require('./storage');
...
const { convertLength, convertTemperature, convertWeight, convertVolume } = require('./conversions');
